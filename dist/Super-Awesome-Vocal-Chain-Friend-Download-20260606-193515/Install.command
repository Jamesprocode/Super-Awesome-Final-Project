...
if [[ -d "$AU_SOURCE" ]]; then
  ...
  xattr -dr com.apple.quarantine "$AU_TARGET/$PLUGIN_NAME.component" 2>/dev/null || true
  echo "Installed AU:"
...
if [[ -d "$VST3_SOURCE" ]]; then
  ...
  xattr -dr com.apple.quarantine "$VST3_TARGET/$PLUGIN_NAME.vst3" 2>/dev/null || true
  echo "Installed VST3:"
...
if [[ -d "$APP_SOURCE" ]]; then
  ...
  xattr -dr com.apple.quarantine "$APP_TARGET/$PLUGIN_NAME.app" 2>/dev/null || true
